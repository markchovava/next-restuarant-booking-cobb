  ...
  return (
    <main className="px-8">
        ...
        <section className=" bg-white py-8 flex flex-col items-start justify-center gap-3 rounded-xl">
            ...
            <RecordPrimary label="Time:" value={preData.time ? preData.time : "Not yet Added"} />
            <RecordPrimary label="Quantity:" value={preData.quantity ?? 'Not yet Added'} />
            <RecordPrimary label="Taken:" value={preData.taken ?? 'Not yet Added'} />
