"use client"
import { _tableDeleteAction } from "@/_api/actions/TableActions"
...
export default function TableListSection({ 
  dbData, 
  locationData }: {dbData: any, locationData: any}) {
    const { 
        isLoading, 
        search, 
        isSearching, 
    ...
    useEffect(() => {
      ...
      async function handleDelete(id: string | number){
        setIsLoading(true)
        try{
            const res = await _tableDeleteAction(id) 
              ...
              <section className="hidden md:block w-full overflow-x-auto rounded-lg border border-gray-400">
                <div className='min-w-[700px]'>
                  ...
                  <section className="bg-gray-300 font-bold text-sm lg:text-base flex items-center">
                    ...
                    <div className="w-[30%] border-r border-gray-400 px-2 py-2">LOCATION</div>
                    ...
                    <div key={key} className="bg-white border border-gray-300 rounded-lg p-4 shadow-sm hover:shadow-md transition-shadow">
                      <div className="space-y-2">
                        ...
                        <div className="pt-2 border-t border-gray-200">
                          <p className="text-xs text-gray-500 font-medium mb-1">LOCATION / FLOOR</p>
                          <p className="text-sm text-gray-900 wrap-break-word">{i.location.name}</p>
                        </div>
